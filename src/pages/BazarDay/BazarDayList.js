  ...
  return (
    <>
      ...
      <div className="mt-[30px]   px-[30px] my-[30px] mx-[20px] md:p-[10px]">
        <h1 className="my-4 text-[#40513B] dark:text-dark_blue2 text-2xl font-Robbi">
          Calendar
        </h1>
        ...
        <div className=" grid  md:grid-cols-2 gap-3">
          <div className="flex justify-center items-center ">
            <Calendar
              ...
              value={date}
              className="dark:bg-[#212121] dark:border-dark_blue1"
            />
          </div>

          <div className="flex justify-center items-start md:justify-start md:items-center">
            <div className=" bg-teal-300 dark:bg-[#aaaa] px-5 py-2 border-spacing-1">
              <p className=" text-btnbg text-lg font-jose dark:text-white">
                Bazar on this day →
                {Object.keys(realdata).length !== 0 ? (
                  <strong className=" text-red-600 dark:text-white">
