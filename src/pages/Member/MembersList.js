        ...
        <table class="min-w-full border-collapse block md:table">
          <thead class="block md:table-header-group">
            <tr class=" bg-[#faf7f7] font-archivo  text-text2    block md:table-row absolute -top-full md:top-auto -left-full md:left-auto shadow-md text-sm  md:relative ">
              ...
              <th class=" p-2 text-left block md:table-cell">Phone</th>
              <th class=" p-2 text-left block md:table-cell">
                Permanent Address
              </th>
              <th class=" p-2 text-left block md:table-cell">Blood group</th>
              ...
              : data?.data?.map((items) => (
                  ...
                  >
                    ...
                    <td className=" flex  py-2 px-4 md:px-2 text-left  md:table-cell">
                      ...
                      <td className=" text-btnbg">{items.phone}</td>
                    </td>
                    <td className=" flex  py-2 px-4 md:px-2 text-left  md:table-cell">
                      <span class="inline-block w-1/3 md:hidden font-bold">
                        permanent address
                      </span>
                      <td className=" text-btnbg">{items.permanentaddress}</td>
                    </td>
                    <td className=" flex  py-2 px-4 md:px-2 text-left  md:table-cell">
                      <span class="inline-block w-1/3 md:hidden font-bold">
                        Blood group
                      </span>
                      <td className=" text-btnbg">{items.bloodgroup}</td>
                    </td>
                    <td className=" flex  py-2 px-4 md:px-2 text-left  md:table-cell">
                      <span class="inline-block w-1/3 md:hidden font-bold">
                        Actions
